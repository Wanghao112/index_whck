var App = function () {
	...
	var handleBackstretch = function () {
        $.backstretch([
            "../common/img/login/1.jpg"
            , "../common/img/login/2.jpg"
            , "../common/img/login/3.jpg"
            , "../common/img/login/4.jpg"
	...
	var handleChat = function (elem) {
		var append = function() {
			...
			var msg = '';
				...
				msg +=	'<img class="media-object" alt="Generic placeholder image" src="../common/img/chat/headshot2.jpg">';
				msg +=  '</a>';
	...
	var handleSliderNav = function () {
		...
		$('#address-book .slider-content ul li ul li a').click(function(e){
			...
			//Set the image
			$('#contact-card .headshot img').attr('src', '../common/img/addressbook/'+img_id+'.jpg');
		...
		if ($.cookie('gritter_show')) {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    image: '../common/img/gritter/cloud.png',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: '../common/img/gritter/settings.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: '../common/img/gritter/buy.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
	...
	return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../common/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
