var Charts = function () {
    ...
    return {
        ...
        initOtherCharts: function () {
			function chartGrow() {               
                var data = [[0, 2.5],[1, 3.5], [2, 2], [3, 3], [4, 4],[5, 3.5], [6, 3.5], [7, 1], [8, 2], [9, 3], [10, 4],[11, 5], [12, 4], [13, 20], [14, 5], [15, 3.5]];
			...
			//创建折线图
            function chartGrow1() {
                var data = [[0, 2.5],[1, 3.5], [2, 2], [3, 3], [4, 4],[5, 3.5], [6, 3.5], [7, 1], [8, 2], [9, 100], [10, 4],[11, 5], [12, 4], [13, 20], [14, 5], [15, 3.5]];

                var plot = $.plot($("#chart_grow1"), [{
                    data: data,
                    label: "数据单位"
                }], {
                    series: {
